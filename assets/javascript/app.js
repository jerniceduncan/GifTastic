$(document).ready(function() {
  var animals = ["lion", "cat", "dog", "horse", "fish"];

  // Add buttons for original animal array
  function renderButtons(arrToUse) {
    $("animal-buttons").empty();
    for (i = 0; i < movies.length; i++) {
      $("#movie-buttons").append(
        "<button class='btn btn-success' data-movie='" +
          movies[i] +
          "'>" +
          movies[i] +
          "</button>"
  ...
  $("button").on("click", function() {
    ...
    var queryURL =
      "https://api.giphy.com/v1/gifs/search?api_key=OZCzJICdd1seaYMpD4iFzdgEXp8Fy642&q=music&limit=25&offset=0&rating=G&lang=en";
